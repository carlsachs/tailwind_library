...
const MainButton = tw.button`border-2 border-blue-700 w-32 px-4 py-2 rounded hocus:border-opacity-50 hocus:border-blue-400 hocus:text-blue-300 hocus:duration-300`;

const NavigationLink = tw.a`text-blue-400 hocus:cursor-pointer hocus:text-blue-200 hocus:duration-300`;
